...
%    [imageOut] = Hydra.Cuda.NLMeans(imageIn,h,[searchWindowRadius],[nhoodRadius],[device])
...
function [imageOut] = NLMeans(imageIn,h,searchWindowRadius,nhoodRadius,device)
    [imageOut] = Hydra.Cuda.Hydra('NLMeans',imageIn,h,searchWindowRadius,nhoodRadius,device);
end
