function times = ClosureGraph(sizes_rc,sizeItter,types,typeItter,numTrials)
    ...
    for i = sizeItter
        ...
        for ty = typeItter
            ...
            for j=1:numTrials
                [ts(j,1),ts(j,2)] = Performance.Closure(im,kernel);
            end
    ...
    Performance.PlotResults(times,'Closure [5,5,3]');
end