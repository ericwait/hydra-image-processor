function times = AddImageWithGraph(sizes_rc,sizeItter,types,typeItter,numTrials)
    ...
    prgs = Utils.CmdlnProgress(numItters,true,'AddImageWith');
    j = 0;
    for ty = typeItter
        for i = sizeItter
    ...
    Performance.PlotResults(times,'Add Image With Another');
end