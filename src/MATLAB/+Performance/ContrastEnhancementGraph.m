function times = ContrastEnhancementGraph(sizes_rc,sizeItter,types,typeItter,numTrials)
    ...
    prgs = Utils.CmdlnProgress(numItters,true,'ContrastEnhancement');
    j = 0;
    for ty = typeItter
        for i = sizeItter
    ...
    Performance.PlotResults(times,'Contrast Enhancement');
end