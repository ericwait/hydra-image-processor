...
%    arrayOut = ImProc.ElementWiseDifference(array1In,array2In,[device])
...
function arrayOut = ElementWiseDifference(array1In,array2In,device)
    try
        arrayOut = ImProc.Cuda.ElementWiseDifference(array1In,array2In,device);
    catch errMsg
        warning(errMsg.message);
        arrayOut = ImProc.Local.ElementWiseDifference(array1In,array2In,device);
    end
end
