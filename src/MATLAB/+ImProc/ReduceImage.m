...
function imageOut = ReduceImage(imageIn,reductionFactor,method)
    ...
    if (n>0)
       ...
       try
            imageOut = ImProc.Cuda.ReduceImage(imageIn,reductionFactor,method,device);
        catch errMsg
        	delete(mutexfile);
        	throw(errMsg);
        end
        ...
        imageOut = lclReduceImage(imageIn,reductionFactor,method);
    end
end
