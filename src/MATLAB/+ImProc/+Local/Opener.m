function arrayOut = Opener(arrayIn,kernel,numIterations,device,suppressWarning)
     error('Opener not yet implemented in MATLAB!'); %delete this line when implemented
