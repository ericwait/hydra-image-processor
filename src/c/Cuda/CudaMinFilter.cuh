...
__global__ void cudaMinFilter(CudaImageContainer<PixelTypeIn> imageIn, CudaImageContainer<PixelTypeOut> imageOut,
...
template <class PixelTypeIn, class PixelTypeOut>
void cMinFilter(ImageContainer<PixelTypeIn> imageIn, ImageContainer<PixelTypeOut>& imageOut,
