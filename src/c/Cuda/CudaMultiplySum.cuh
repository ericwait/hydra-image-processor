...
template <class PixelTypeIn, class PixelTypeOut>
void cMultiplySum(ImageContainer<PixelTypeIn> imageIn, ImageContainer<PixelTypeOut>& imageOut,ImageContainer<float> kernel, int numIterations = 1, int device = -1)
{
