...
__global__ void cudaUnmixing( const CudaImageContainer<PixelType> imageIn1, const CudaImageContainer<PixelType> imageIn2,
							 CudaImageContainer<PixelType> imageOut1, Vec<size_t> hostKernelDims, PixelType minPixelValue,
							 PixelType maxPixelValue )
{
