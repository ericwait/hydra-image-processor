...
void maxFilter(const ImageContainer* image, ImageContainer* imageOut, Vec<unsigned int> neighborhood, double* kernel=NULL);
...
void minFilter(const ImageContainer* image, ImageContainer* imageOut, Vec<unsigned int> neighborhood, double* kernel=NULL);
void morphClosure(const ImageContainer* image, ImageContainer* imageOut, Vec<unsigned int> neighborhood, double* kernel=NULL);
void morphOpening(const ImageContainer* image, ImageContainer* imageOut, Vec<unsigned int> neighborhood, double* kernel=NULL);
