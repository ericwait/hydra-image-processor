...
{
public:
	ImageContainer(size_t width, size_t height, size_t depth);
	ImageContainer(Vec<size_t> dims);
	ImageContainer(HostPixelType* imageIn, Vec<size_t> dims);
	...
	void setImagePointer(HostPixelType* imageIn, Vec<size_t> dims);
	void loadImage(const HostPixelType* imageIn, size_t width, size_t height, size_t depth);
	void loadImage(const HostPixelType* imageIn, Vec<size_t> dims);
