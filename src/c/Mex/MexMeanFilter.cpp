...
template <typename T>
void MexMeanFilter_run(const mxArray* inIm, mxArray** outIm, ImageView<float> kernel, int numIterations, int device)
{
...
{
	helpLines.push_back("This will take the mean of the given neighborhood.");
